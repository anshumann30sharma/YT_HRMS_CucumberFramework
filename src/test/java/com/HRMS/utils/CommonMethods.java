...
public class CommonMethods extends com.HRMS.testbase.PageInitializer {
	 ...
	 * @param text
	 */
	public static void sendText(WebElement username, String text) {
		username.clear();
		username.sendKeys(text);
		
	}
//	protected void sendText(String string, String text) {
//	}
	...
	public static void selectDdValue(WebElement element, String textToSelect) {
		...
		public void selectDdValue(WebElement string, WebElement string2) {
	}
	...
	public static byte[] takeScreenshot(String filename) {
		...
		String destinationFile=Constants.SCREENSHOT_FILEPATH+filename+getTimesStamp()+".png";
		try {
